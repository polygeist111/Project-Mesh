...
object BluetoothUuids {
    ...
    // BLE GATT service UUID for the UUID Allocation Service
    val ALLOCATION_SERVICE_UUID: UUID =
        UUID.fromString("d8a8f0e8-1f62-4b1f-9c38-7f5b5a1e1d3b")
    // BLE GATT characteristic UUID under the Allocation Service
